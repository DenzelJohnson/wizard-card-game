...
export function RulesDialog({ open, onClose, returnFocusRef }: RulesDialogProps) {
  ...
  return (
    ...
    >
      ...
      <button ref={closeButtonRef} type="button" onClick={onClose} aria-label="Close rules">
        Close
      </button>
      ...
      <section>
        ...
        <p>
          ...
          Jester means no trump. In the final round every card is dealt, so there is no up-card and
          no trump.
        </p>
      </section>
      <section>
      ...
      <section>
        ...
        <p>
          The first Wizard wins. With no Wizard, the highest trump wins; without trump, the highest
          card of the led suit wins. If all four cards are Jesters, the first Jester wins.
        </p>
      </section>
      <section>
        <h3>Scoring</h3>
